...
function StepperItem({
  ...
  const currentIndex = steps.findIndex((s) => s.id === stepper.id);
...
function StepperTrigger({
  ...
  return (
    <button
      ...
      className={cn(
        "inline-flex cursor-pointer bg-amber-300 items-center outline-none disabled:pointer-events-none disabled:opacity-60",
